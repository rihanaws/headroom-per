...
Phase 3 — read-only Claude Mem ingestion, 15-minute poll, dedupe by hash, last-write-wins conflict resolution with manual-review flag if confidence delta exceeds 0.3.
